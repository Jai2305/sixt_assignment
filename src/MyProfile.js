...
const MyProfile = ()=>{
    ...
    const displayProfile= ()=>{
        if(localStorage.key("userData")){
            ...
            <h3>{JSON.parse(localStorage.getItem("userData"))[1]}</h3>
            <h3>{JSON.parse(localStorage.getItem("userData"))[2]}</h3>
            <h3>{JSON.parse(localStorage.getItem("userData"))[3]}</h3>
            <h3>{JSON.parse(localStorage.getItem("userData"))[4]}</h3>
            </div>
        )
        }
        else{
    ...
    return(
        <div>
            ...
            <div id="create-profile">
                <h3 id="logo">Create your profile</h3>
                <form id = "form">
