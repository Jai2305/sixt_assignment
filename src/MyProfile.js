    ...
    return(
        <div>
            ...
            <div class="card" id="Profile">
                ...
                <h1 style={{"color":"black"}}>{localStorage.key("userData")? JSON.parse(localStorage.getItem("userData"))[0]+" "+JSON.parse(localStorage.getItem("userData"))[1] : "No profile Created"}</h1>
                <div class="cont">
                    <p style={{"color":"black"}}>
